...
const INITIAL_ATOM_SHIFT_NOTES: ShiftNote[] = [
  {
    id: 'sn-1',
...
interface AtomShiftNotesProps {
  theme?: 'dark' | 'light'
  selectedFlightNumber?: string
}

export const AtomShiftNotes: React.FC<AtomShiftNotesProps> = ({
  theme = 'dark',
}) => {
  const isDark = theme === 'dark'
  const [notes, setNotes] = useState<ShiftNote[]>(INITIAL_ATOM_SHIFT_NOTES)
  const [selectedNoteId, setSelectedNoteId] = useState<string>(INITIAL_ATOM_SHIFT_NOTES[0].id)
  ...
  return (
    <div
      className={`flex-1 flex flex-col rounded-2xl border overflow-hidden transition-colors ${
        isDark ? 'bg-[#0F172A] border-[#334155] text-[#F9FAFB]' : 'bg-white border-slate-200 text-slate-900 shadow-sm'
      }`}
    >
          ...
          <div>
            <div className="flex items-center gap-2">
              <h2 className="text-base font-black uppercase tracking-tight text-white">
                ATOM OCC Shift Handover Workspace
              </h2>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative w-64">
            ...
            <input
              ...
              className="w-full pl-8 pr-3 py-1.5 rounded-xl text-xs font-medium bg-[#0F172A] border border-[#334155] text-slate-200 placeholder-slate-500 focus:outline-none focus:border-[#C8102E]"
            />
          </div>
      ...
      <div className="flex-1 flex min-h-0 overflow-hidden">
        ...
        >
                  ...
                  <button
                    ...
                    className={`px-2.5 py-1 rounded-xl text-xs font-mono font-bold border transition-colors ${
                      selectedCategory === cat
                        ...
                        : 'bg-[#1E293B]/60 border-[#334155] text-slate-400 hover:text-slate-200'
                    }`}
                  >
                    {cat}
                  </button>
          ...
          <div className="p-3 rounded-xl border bg-[#1E293B] border-[#334155] space-y-1.5 text-xs">
        ...
        >
          <div className="p-3 border-b border-[#334155] flex items-center justify-between text-xs font-bold text-slate-400">
              ...
              return (
                <div
                  ...
                  className={`p-3 rounded-xl border cursor-pointer space-y-2 transition-all ${
                    isSelected
                      ? 'bg-[#1E293B] border-[#C8102E] shadow-sm'
                      : 'bg-[#1E293B]/60 border-[#334155] hover:border-slate-600'
                  }`}
                >
                  ...
                  <div className="flex items-center justify-between text-[10px] text-slate-500 pt-1 border-t border-[#334155] font-mono">
        ...
        {activeNote && (
          <div className="flex-1 flex flex-col overflow-y-auto custom-scrollbar p-6 space-y-5">
            {/* Note Header Details */}
            <div className="space-y-3 border-b border-[#334155] pb-4">
            ...
            <div className="p-5 rounded-2xl border bg-[#1E293B] border-[#334155] space-y-4">
              <span className="text-[10px] font-bold uppercase tracking-wider text-slate-400 block border-b border-[#334155] pb-2">
            ...
            <div className="p-4 rounded-2xl border bg-[#1E293B] border-[#334155] space-y-3">
              ...
              {activeNote.attachments && activeNote.attachments.length > 0 ? (
                <div className="grid grid-cols-2 gap-2 text-xs font-mono">
                  {activeNote.attachments.map((att, idx) => (
                    <div
                      key={idx}
                      className="p-3 rounded-xl border bg-[#0F172A] border-[#334155] flex items-center justify-between"
                    >
              ...
              <div className="space-y-2 text-xs font-mono">
                {activeNote.history && activeNote.history.length > 0 ? (
                  activeNote.history.map((hist, idx) => (
                    <div key={idx} className="flex items-center justify-between p-2 rounded-lg bg-[#0F172A] border border-[#334155]">
                      <div className="flex items-center gap-2">
      ...
      {showAddModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/70 backdrop-blur-xs fade-in select-none">
          <div className="w-full max-w-lg bg-[#1E293B] border border-[#334155] rounded-2xl shadow-2xl p-5 space-y-4">
            <div className="flex items-center justify-between border-b pb-3 border-[#334155]">
            ...
            <form onSubmit={handleAddNote} className="space-y-3 text-xs">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-xl bg-[#0F172A] border border-[#334155] text-white focus:outline-none focus:border-[#C8102E]"
                />
              </div>
              ...
              <div className="grid grid-cols-3 gap-2">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-2 py-1.5 rounded-xl bg-[#0F172A] border border-[#334155] text-white font-mono"
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-2 py-1.5 rounded-xl bg-[#0F172A] border border-[#334155] text-white font-mono uppercase"
                  />
                </div>
              </div>
