...
import { FilterState, OperationalFlag, OperationalIcon } from '../types/atom'
import { FLAG_META, ICON_META } from '../mock/atomData'
      ...
      <div className="fixed inset-y-0 right-0 max-w-full flex pl-10">
        <div
          className={`w-screen max-w-md shadow-2xl flex flex-col border-l fade-in transition-colors ${
            isDark ? 'bg-[#1E293B] border-[#334155] text-[#F9FAFB]' : 'bg-white border-slate-200 text-slate-900'
          }`}
        >
          {/* Header */}
          <div
                ...
                {ALL_ICONS.map((icon) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="truncate">{meta ? meta.label : icon}</span>
                    </button>
                  )
                })}
              </div>
